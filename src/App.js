...
class App extends Component {
  ...
  onClickPlayAgain = () => {
    this.setState({...defaultValues}, this.componentDidMount())
  }

  render() {
    const {score, timer, gameOver, activeTabId, currentImageId} = this.state
    ...
    return (
      <div className="app-container">
        ...
        <div className="game-view-container">
          {gameOver ? (
            <GameOver score={score} playAgain={this.onClickPlayAgain} />
          ) : (
            <Game
              tabsList={tabsList}
